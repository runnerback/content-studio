...
import { builtinBg1, builtinBg2, builtinBg3, builtinBg4, builtinBg5, builtinBg6 } from '../assets/backgrounds/builtinBackgrounds.ts';
...
export class BackgroundSettingModal extends Modal {
    ...
    constructor(
        app: App,
        onSubmit: (settings: BackgroundSettings) => void,
